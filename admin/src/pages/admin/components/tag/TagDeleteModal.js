...
const TagDeleteModal = ({ showDeleteModal, setShowDeleteModal, handleDeleteMenu }) => {
    return (
        <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
            ...
            <Modal.Footer>
                ...
                <Button variant="danger" onClick={handleDeleteMenu} className={'d-flex align-items-center'}>
