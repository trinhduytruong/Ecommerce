...
const PaymentStatus = ( { location } ) =>
{
	...
	const updatePaymentStatus = async () =>
	{
		...
		const response = await API_SERVICE.put( 'users/orders/update-payment-status', dataOrder );
					...
					<div className="container">
						<div className="row justify-content-center">
							<div className="col-xl-7 col-lg-8 text-center">
								{
									img && <img src={ img } style={ { width: '80px', height: '80px' } } alt='payment' className="d-block mx-auto" />
								}
								...
								{/* { content ? (
									<div className="mx-auto">
										...
										<div className="text-center mx-auto">
											<img src="https://img001.prntscr.com/file/img001/AezE7Si4RsWGONiW6uBeBA.png" style={{width: '200px', height: '200px'}} />
