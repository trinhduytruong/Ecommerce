  ...
  return (
    <Fragment>
      <MetaTags>
        ...
        <meta
          name="description"
          content="Wishlist page of flone react minimalist eCommerce."
        />
      </MetaTags>
                              ...
                              <tr key={key}>
                                ...
                                <td className="product-wishlist-cart">
                                  {wishlistItem.slug ? (
                                    ...
                                    <Link
                                      to={`${process.env.PUBLIC_URL}/sp/${wishlistItem.slug}`}
                                    >
                                      Select option
                                    </Link>
                                  ) : wishlistItem.stock &&
                  ...
                  <div className="col-lg-12">
                    <div className="cart-shiping-update-wrapper">
                      <div className="cart-shiping-update">
                        <Link
                          to={process.env.PUBLIC_URL + "/san-pham"}
                        >
                          Cửa hàng
                        </Link>
                      </div>
