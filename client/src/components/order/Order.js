...
const Order = (props) => {
  ...
  const getOrders = async (params) => {
    ...
    let response = await API_SERVICE.get("users/orders", {
      ...params,
      code: code,
    });
  ...
  const genStatus = (data, status) => {
    ...
    return (
      <p className={" mb-0 " + result?.className || "text-warning"}>
        {result?.name || "Chờ duyệt"}
      </p>
    );
  };
  ...
  const voteProduct = async (e) => {
    ...
    if (errorData) {
      console.log("errorData -----> ", errorData, formVote);
  ...
  return (
    <div className="myaccount-area pb-80 pt-100">
          ...
          <div className="ml-auto mr-auto col-lg-9">
            <div className="myaccount-wrapper">
              <div className=" w-50 mx-auto mb-2 d-flex form-group mb-4">
                ...
                />
                <button
                  className="btn ml-2 text-nowrap btn-xl btn-success"
                  onClick={(e) => {
                                ...
                                <div className="row mb-md-3">
                                  ...
                                  <div className="col-sm-3 text-right">
                                    <span
                                      style={{ fontWeight: 600, fontSize: 16 }}
                                    >
                                      {customNumber(item.shipping_amount) || 0}
                                    </span>
                                  </div>
                                </div>
                                <div className="row mb-md-3">
                                  ...
                                  <div className="col-sm-3 text-right">
                                    <span
                                      style={{ fontWeight: 600, fontSize: 16 }}
                                    >
                                      {customNumber(item.tax_amount) || 0}
                                    </span>
                                  </div>
                                </div>
      ...
      <Modal show={showModalVote} onHide={handleClose} size={"sm"}>
        ...
        <Modal.Body>
          ...
          <Form>
            <div className="text-center d-flex justify-content-center">
              <StarPage
                vote_number={formVote.rating.value}
                setVoteNumber={(e) => {
                  setFormVote({
                    ...formVote,
                    rating: { ...formVote.rating, value: e },
                  });
                }}
                is_form={true}
              />
            ...
            <Form.Group controlId="formEmail">
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  setFormVote({
                    ...formVote,
                    comment: { ...formVote.comment, value: e?.target?.value },
                  });
              ...
              />
              {errorVote?.comment && (
                <span className="text-danger">{errorVote?.comment}</span>
              )}
            </Form.Group>
          </Form>
        </Modal.Body>
